        ...
        <TouchableOpacity 
            ...
            <View style={{ backgroundColor: 'transparent', flexDirection: 'row', flex: 2 }}>
                <View style={{ flex: 4, backgroundColor: 'transparent' , padding:5, justifyContent:'center'}}>
                    <Text style={{ color: 'black', fontWeight: '300', fontSize: 18 }}>OverView</Text>
                    <Text style={{ color: 'black', fontWeight: 'normal', fontSize: 14 , opacity: 0.5}}>Tap to view full report</Text>
                </View>
            ...
            <View style={{ backgroundColor: 'transparent', flex: 3 ,flexDirection:'row'}}>
                <View style={{flex:3,backgroundColor:'transparent', padding:5,justifyContent:'space-evenly'}}>
                    <Text style={{ color: 'black', fontWeight: 'normal', fontSize: 16 ,}}>Inflow</Text>
                    <Text style={{ color: 'black', fontWeight: 'normal', fontSize: 16 ,}}>Outflow</Text>
                    <View style={{height:1,}}/>
                    <Text/>
                </View>
